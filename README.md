...
> ⚠️ **Keep backups of your data**. While snapshots have been significantly hardened (NBD safety, taint mode, live VM/LXC support), this project is still beta — always maintain independent backups.
